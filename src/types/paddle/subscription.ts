// Backwards-compatible subscription type exports. The interfaces below
// serve as the canonical Paddle Classic event types.
 ...
 * `subscription_paused`
 */
export interface SubscriptionPaused extends Subscription {
  /**
   * The date and time when the subscription was requested to be paused. The subscription will
   * be paused on the `paused_from` date.
   */
